...
public class TracingExample {
	...
	public TracingExample() throws AccumuloException, AccumuloSecurityException, IOException, KeeperException, InterruptedException {
			
	}
	
	public void enableTracing(Opts opts) throws AccumuloException, AccumuloSecurityException, IOException, KeeperException, InterruptedException {
	 ...
	 */
	public static void main(String[] args) throws AccumuloException, AccumuloSecurityException, TableNotFoundException, IOException, KeeperException, InterruptedException, TableExistsException {
